...
namespace fyp.Controllers
{
    public class QuizController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            var lstques  = dbs.ToList();
            ViewData["ques"] = new SelectList(lstques, "QuizId", "Title");
        ...
        public IActionResult Update(int id)
        {
            ...
            if (quiz != null)
            {
                DbSet<Question> dbsPokes = _dbContext.Pokedex;
                var lstPokes = dbsPokes.ToList();
                ViewData["pokes"] = new SelectList(lstquest, "Id", "Name");
